...
## 4.1. Les objectifs de la cryptographie
...
### 4.1.1. Les cryptographies symétrique et asymétrique
...
### 4.1.2. La cryptographie asymétrique
...
### 4.1.3. Articulation entre cryptographie asymétrique et cryptographie symétrique
...
## 4.2. Fonctionnement d'une connexion SSH

### 4.2.1. Étape d'établissement de la connexion
...
### 4.2.2. Authentification du client
...
### 4.2.5. Fermeture de la connexion
...
## 4.4. Les composants de base de SSH
...
### 4.5.6. sftp (SSH File Transfer Protocol)
...
## 4.6. Commandes de base pour SSH

### 4.6.1. Génération de clés SSH
...
## 4.8. Le fichier `authorized_keys`
